...
from imgViolin import *
from imgBombo import *
from imgFlauta import *
class Instrumentos:
...
class guitarra(Instrumentos):
     def afinar():
          return (f"la guitarra se esta afinando{img_guitarra}" )
     def tocar():
...
class violin(Instrumentos):
     def afinar():
          return (f"El violin se esta afinando{img_violin()} ")
     def tocar():
...
class bombo(Instrumentos):
     def afinar():
          return (f"el Bombo no se afina {img_bombo()}")
     def tocar():
...
class flauta(Instrumentos):
     def afinar():
          return (f"la flauta no se afina{img_flauta()} ")
     def tocar():
